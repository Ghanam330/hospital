...
class UpdateUserPatientApp extends StatefulWidget {
  UpdateUserPatientApp({Key? key, required this.patientModel}) : super(key: key);
  PatientModel patientModel;

  @override
  State<UpdateUserPatientApp> createState() => _UpdateUserPatientAppState();
}

class _UpdateUserPatientAppState extends State<UpdateUserPatientApp> {
          ...
          if (state is HospitalGetUserLoadingState) {
            ...
            phoneController.text =
               PatientAppCubit
                    ...
                    .patientModel!
                    .phoneNumber;
            ageController.text =PatientAppCubit
                .get(context)
                .patientModel!
                .age;
            selectedGender =PatientAppCubit
                .get(context)
                .patientModel!
                .gender;
            return Scaffold(
              ...
              appBar: AppBar(
                ...
                actions: <Widget>[
                  TextButton(
                    onPressed: () {
                     PatientAppCubit.get(context).updateUser(
                                ...
                                children: [
                                  CircleAvatar(
                                    ...
                                    child: CircleAvatar(
                                      ...
                                      backgroundImage:PatientAppCubit
                                          .get(context)
                                          .profileImage ==
                                          null
                                          ? NetworkImage(PatientAppCubit
                                          .get(context)
                                          .patientModel!
                                          .imageUrl)
                                          : FileImage(PatientAppCubit
                                          .get(context)
                          ...
                          Column(
                            children: [
                              CustomButton(
                                ...
                                onPress: () {
                                 PatientAppCubit.get(context).uploadProfileImage(
                                      name: nameController.text,
                                      phone: phoneController.text,
                                      gender: selectedGender,
                                      age: ageController.text,
