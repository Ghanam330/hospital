...
/// Main color pallete
 ...
 const Color lightBlue = Color(0xffE5EFDF);
 const Color lightGrey = Color(0xffE1E1E1);
 const Color lightGrey1 = Color(0xfff7f7fa);
 const Color kPrimaryBlue = Color(0xFF2196F3);
 const Color kLightOrangeColor = Color(0xFFFFF2ED);
 const Color kLightGreyColor = Color(0xFF848484);
